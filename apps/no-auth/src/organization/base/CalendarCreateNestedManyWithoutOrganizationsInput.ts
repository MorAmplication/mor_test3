...
@InputType()
class CalendarCreateNestedManyWithoutOrganizationsInput {
...
export { CalendarCreateNestedManyWithoutOrganizationsInput as CalendarCreateNestedManyWithoutOrganizationsInput };
